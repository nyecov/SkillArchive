...
### 4.5. `delete_ontology_edge`
Removes an existing edge from the Knowledge Graph. Critical for resolving DAG cycle errors and refactoring outdated architectural rules.
```json
{
  "properties": {
    "source_entity": { "type": "string" },
