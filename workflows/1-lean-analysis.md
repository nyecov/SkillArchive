...
> **FAST-PATH BYPASS:** If the input is deemed "Routine" or "Low-Risk" based on the following physical heuristics, the Lead Agent MUST skip the sequential Lean Analysis phases to prevent "Methodology Muri" (Cognitive Overburden):
> - **Scope:** Modifies **< 3 files**.
> - **Dependencies:** Introduces **0 new libraries or external dependencies**.
> - **Nature:** Pure formatting, typo fixes, documentation updates, or localized logic fixes with existing tests.
> 
> Bypassing this protocol is authorized to preserve execution velocity. Proceed directly to execution or Phase 9 (Output).
