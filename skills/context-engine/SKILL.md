...
Refer to the [Configuration Reference](../../tools/config-reference.md) for the standard `stdio` and Daemon mode configuration strings for Windows and Unix environments.
